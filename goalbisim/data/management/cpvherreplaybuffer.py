...
class CPVHERReplayBuffer(HERReplayBuffer):
    ...
    def sample(self, batch_size = None, fetch_states = False):
        ...
        if fetch_states:
            states = None
            next_states = None
            kwargs = {'states' : states, 'next_states' : next_states, 'rtg' : rtg_rewards, 'td' : tds, 'idxs' : idxs, 'pos' : pos, 'init_obs': init_obses}
        else:
            kwargs = {'rtg' : rtg_rewards, 'td' : tds, 'idxs' : idxs, 'pos' : pos, 'init_obs': init_obses}
