...
replay_buffer = collect_analogy_offline_replay('demo', env, 0.99, replay_buffer, 2000)
try:
    replay_buffer.save(save_loc, "replay_sawyer_v7_easy_analogy_rot")
except:
